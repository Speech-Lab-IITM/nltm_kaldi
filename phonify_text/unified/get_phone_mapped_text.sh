...
sed -i 's/"axx"/"ऎ"/g' wordpronunciation
...
sed -i 's/"dxhq"/"ढ़"/g' wordpronunciation
sed -i 's/"dxq"/"ड़"/g' wordpronunciation
sed -i 's/"ei"/"ऐ"/g' wordpronunciation
sed -i 's/"ai"/"ऐ"/g' wordpronunciation
sed -i 's/"eu"/"्"/g' wordpronunciation

sed -i 's/"gh"/"घ"/g' wordpronunciation
sed -i 's/"gq"/"ग़"/g' wordpronunciation
sed -i 's/"hq"/"H"/g' wordpronunciation
sed -i 's/"jh"/"J"/g' wordpronunciation
sed -i 's/"kh"/"ख"/g' wordpronunciation
sed -i 's/"khq"/"ख़"/g' wordpronunciation
sed -i 's/"kq"/"क़"/g' wordpronunciation
...
sed -i 's/"nd"/"ऩ"/g' wordpronunciation
sed -i 's/"ng"/"ङ"/g' wordpronunciation
sed -i 's/"nj"/"ञ"/g' wordpronunciation
sed -i 's/"nk"/"़"/g' wordpronunciation
...
sed -i 's/"rx"/"ऱ"/g' wordpronunciation
