...
commonly used in many kaldi python3 scripts.
"""
...
class StrToBoolAction(argparse.Action):
    """ A custom action to convert bools from shell format i.e., true/false
        to python3 format i.e., True/False """
...
class NullstrToNoneAction(argparse.Action):
    ...
    python3. This is necessary as shell scripts print null strings when a
    variable is not specified. We could use the more apt None in python3. """
...
class smart_open(object):
    """
    This class is designed to be used with the "with" construct in python3
    to open files. It is similar to the python3 open() function, but
